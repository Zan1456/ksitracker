...
import { ChallengeTaskForm } from "@/components/admin/challenge-task-form";
...
export function ChallengeTaskManager({ tasks }: { tasks: ChallengeTask[] }) {
    ...
    <div className="flex flex-col gap-2">
      ...
      {creating ? (
        <div className="rounded-[9px] border border-border-strong bg-bg-inset p-3.5">
          <ChallengeTaskForm onSaved={() => setCreating(false)} />
        </div>
      ) : (
